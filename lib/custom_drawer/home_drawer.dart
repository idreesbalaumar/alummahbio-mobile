...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.Beneficiaries,
        labelName: 'Beneficiaries',
        isAssetsImage: true,
        imageName: 'assets/images/bebeficiaryimage.png',
      ),
      DrawerList(
        index: DrawerIndex.CaptureNewBeneficiary,
        labelName: 'Capture New Beneficiary',
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset('assets/images/bebeficiaryimage.png'),
                            ),
                          ),
                        ),
                      );
                ...
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                      ? Container(
                          width: 24,
                          height: 24,
                          child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.blue : Colors.black87),
                        )
                      : Icon(listData.icon.icon, color: widget.screenIndex == listData.index ? Colors.blue : Colors.black87),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.blue : Colors.black87,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
